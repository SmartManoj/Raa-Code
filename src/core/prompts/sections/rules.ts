...
- **CRITICAL IMAGE ANALYSIS RULE**: When asked to describe or analyze image files, you MUST use the browser_action tool to properly view and analyze the image instead of making assumptions or hallucinating about the image content. Launch the browser with a file:// URL to the image file, examine the actual visual content in the screenshot, then close the browser. This prevents hallucination and ensures accurate image analysis based on the actual visual content.
